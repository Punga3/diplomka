...
Let us note that if we have multiple boolean valued structures $\M_1,\M_2,\dots$ we may add the name of the structure as a prefix to the valuation function to get $\M_1\bbl-\bbr$ and $\M_2\bbl-\bbr$ to avoid ambiguity or to emphasize the structure where the valuation takes place.
